        ...
        pub mod context7 {
            ...
            pub mod context7 {
                ...
                pub struct LibraryResult {
                    ...
                    pub code_snippets: u32,
                    pub trust_score: u32,
                    pub versions: _rt::Vec<_rt::String>,
                }
                impl ::core::fmt::Debug for LibraryResult {
                    fn fmt(
                        &self,
                        f: &mut ::core::fmt::Formatter<'_>,
                    ) -> ::core::fmt::Result {
                        f.debug_struct("LibraryResult")
                            .field("id", &self.id)
                            .field("name", &self.name)
                            .field("description", &self.description)
                            .field("code-snippets", &self.code_snippets)
                            .field("trust-score", &self.trust_score)
                ...
                pub struct SearchResponse {
                    pub success: bool,
                    pub results: _rt::Vec<LibraryResult>,
                ...
                impl ::core::fmt::Debug for DocsResponse {
                    fn fmt(
                        &self,
                        f: &mut ::core::fmt::Formatter<'_>,
                    ) -> ::core::fmt::Result {
                        f.debug_struct("DocsResponse")
                            .field("success", &self.success)
                ...
                pub unsafe fn _export_resolve_library_id_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                ) -> *mut u8 {
                    ...
                    let result1 = T::resolve_library_id(_rt::string_lift(bytes0));
                    ...
                    *ptr2.add(0).cast::<u8>() = (match success3 {
                    ...
                    for (i, e) in vec10.into_iter().enumerate() {
                        let base = result10.add(i * 40);
                        {
                            let LibraryResult {
                                id: id4,
                                name: name4,
                                description: description4,
                                code_snippets: code_snippets4,
                                trust_score: trust_score4,
                                versions: versions4,
                            } = e;
                            ...
                            *base.add(24).cast::<i32>() = _rt::as_i32(code_snippets4);
                            *base.add(28).cast::<i32>() = _rt::as_i32(trust_score4);
                            let vec9 = versions4;
                            let len9 = vec9.len();
                    ...
                    *ptr2.add(8).cast::<usize>() = len10;
                    *ptr2.add(4).cast::<*mut u8>() = result10;
                    match error3 {
                        Some(e) => {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_resolve_library_id<T: Guest>(arg0: *mut u8) {
                    ...
                    _rt::cabi_dealloc(base13, len13 * 40, 4);
                    let l14 = i32::from(*arg0.add(12).cast::<u8>());
                    match l14 {
                        0 => {}
                        _ => {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_get_library_docs_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                    arg2: i32,
                    arg3: *mut u8,
                    ...
                    let len0 = arg1;
                    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
                    let result2 = T::get_library_docs(
                    ...
                    *ptr3.add(0).cast::<u8>() = (match success4 {
                        true => 1,
                        false => 0,
                    }) as u8;
                    match content4 {
                    ...
                    match error4 {
                        Some(e) => {
                            *ptr3.add(16).cast::<u8>() = (1i32) as u8;
                            ...
                            let len6 = vec6.len();
                            ::core::mem::forget(vec6);
                            *ptr3.add(24).cast::<usize>() = len6;
                            *ptr3.add(20).cast::<*mut u8>() = ptr6.cast_mut();
                        }
                        None => {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_get_library_docs<T: Guest>(arg0: *mut u8) {
                ...
                pub trait Guest {
                    ...
                    fn resolve_library_id(library_name: _rt::String) -> SearchResponse;
                    /// Fetches documentation for a library using Context7-compatible library ID
                    fn get_library_docs(
                        context7_compatible_library_id: _rt::String,
                        topic: Option<_rt::String>,
                        tokens: Option<u32>,
                    ) -> DocsResponse;
                }
                #[doc(hidden)]
                macro_rules! __export_local_context7_context7_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "local:context7/context7@0.1.0#resolve-library-id"] unsafe extern
                        "C" fn export_resolve_library_id(arg0 : * mut u8, arg1 : usize,)
                        -> * mut u8 { $($path_to_types)*::
                        _export_resolve_library_id_cabi::<$ty > (arg0, arg1) }
                        #[export_name =
                        "cabi_post_local:context7/context7@0.1.0#resolve-library-id"]
                        unsafe extern "C" fn _post_return_resolve_library_id(arg0 : * mut
                        u8,) { $($path_to_types)*::
                        __post_return_resolve_library_id::<$ty > (arg0) } #[export_name =
                        "local:context7/context7@0.1.0#get-library-docs"] unsafe extern
                        "C" fn export_get_library_docs(arg0 : * mut u8, arg1 : usize,
                        arg2 : i32, arg3 : * mut u8, arg4 : usize, arg5 : i32, arg6 :
                        i32,) -> * mut u8 { $($path_to_types)*::
                        _export_get_library_docs_cabi::<$ty > (arg0, arg1, arg2, arg3,
                        arg4, arg5, arg6) } #[export_name =
                        "cabi_post_local:context7/context7@0.1.0#get-library-docs"]
                        unsafe extern "C" fn _post_return_get_library_docs(arg0 : * mut
                        u8,) { $($path_to_types)*:: __post_return_get_library_docs::<$ty
                        > (arg0) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_local_context7_context7_0_1_0_cabi;
                #[repr(align(4))]
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_context7_component_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::local::context7::context7::__export_local_context7_context7_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::local::context7::context7);
    };
}
#[doc(inline)]
pub(crate) use __export_context7_component_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.30.0:context7-component:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6915] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xfa4\x01A\x02\x01A\x19\
...
.1\x05\x0f\x01B\x0e\x01ps\x01r\x06\x02ids\x04names\x0bdescriptions\x0dcode-snipp\
etsy\x0btrust-scorey\x08versions\0\x04\0\x0elibrary-result\x03\0\x01\x01p\x02\x01\
ks\x01r\x03\x07success\x7f\x07results\x03\x05error\x04\x04\0\x0fsearch-response\x03\
\0\x05\x01r\x03\x07success\x7f\x07content\x04\x05error\x04\x04\0\x0ddocs-respons\
e\x03\0\x07\x01@\x01\x0clibrary-names\0\x06\x04\0\x12resolve-library-id\x01\x09\x01\
ky\x01@\x03\x1econtext7-compatible-library-ids\x05topic\x04\x06tokens\x0a\0\x08\x04\
\0\x10get-library-docs\x01\x0b\x04\x01\x1dlocal:context7/context7@0.1.0\x05\x10\x04\
\x01'local:context7/context7-component@0.1.0\x04\0\x0b\x18\x01\0\x12context7-com\
ponent\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.215\
